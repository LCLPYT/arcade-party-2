...
class KnockoutMiniGame : MiniGame {
    override fun getId(): Identifier = ApConstants.identifier("knockout")
    ...
    override fun createInstance(gameHandle: MiniGameHandle): MiniGameInstance = KnockoutInstance(gameHandle)
}
