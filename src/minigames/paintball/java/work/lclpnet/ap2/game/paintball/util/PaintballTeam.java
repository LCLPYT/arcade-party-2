...
public record PaintballTeam(Vec3 spawn, float yaw, BlockBox baseBounds, DyeTeamKey templateColor, DyeTeamKey key) implements TeamKeyable {

    public Set<ServerPlayer> participants(TeamManager teamManager, Participants participants) {
    ...
    public static Partial<PaintballTeam, DyeTeamKey> fromJson(JSONObject json) {
        Vec3 spawn = MapUtil.readCenteredVec3d(json.getJSONArray("spawn"));
