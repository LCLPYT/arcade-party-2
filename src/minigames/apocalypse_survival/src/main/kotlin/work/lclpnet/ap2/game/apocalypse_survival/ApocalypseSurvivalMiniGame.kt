...
class ApocalypseSurvivalMiniGame : MiniGame {
    override fun getId() = ApConstants.identifier("apocalypse_survival")
    ...
    override fun createInstance(gameHandle: MiniGameHandle) = ApocalypseSurvivalInstance(gameHandle)
}
