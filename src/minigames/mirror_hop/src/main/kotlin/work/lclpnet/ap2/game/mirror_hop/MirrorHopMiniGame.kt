...
class MirrorHopMiniGame : MiniGame {
    override fun getId(): Identifier = ApConstants.identifier("mirror_hop")
    ...
    override fun createInstance(gameHandle: MiniGameHandle): MiniGameInstance = MirrorHopInstance(gameHandle)
}
