...
class BlockDissolveMiniGame : MiniGame {
    override val id = ApConstants.identifier("block_dissolve")
    ...
    override fun createFactory(gameHandle: MiniGameHandle): MiniGameFactory = MapLevelGameFactory(::BlockDissolveInstance)
}
