...
class MiningBattleMiniGame : MiniGame {
    override fun getId(): Identifier = ApConstants.identifier("mining_battle")
    ...
    override fun createInstance(gameHandle: MiniGameHandle): MiniGameInstance = MiningBattleInstance(gameHandle)
}
