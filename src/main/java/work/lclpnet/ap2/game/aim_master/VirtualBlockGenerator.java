...
public class VirtualBlockGenerator {

    private final int positions;
    private IndexedSet<Block> blockOptions = new IndexedSet<>();

    public VirtualBlockGenerator(int positions) {
        this.positions = positions;
        setBlockOptions(blockOptions);
    }

    public void setBlockOptions(IndexedSet<Block> blockOptions) {
