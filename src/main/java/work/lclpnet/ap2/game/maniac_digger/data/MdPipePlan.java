...
public class MdPipePlan {
    ...
    private final BlockState wallMaterial = Blocks.GLASS.getDefaultState();
    ...
    public MdPipePlan(Vec3i dimensions, int diameter, Function<BlockPos, BlockState> fillMaterial) {
    ...
    public void placeVertical(BlockPos pos) {
        int d = diameter - 1;
        ...
        for (int x = 0; x < diameter; x++) {
            for (int z = 0; z < diameter; z++) {
                ...
                if (x == 0 || x == d || z == 0 || z == d) {
                    struct.setBlockState(tmpPos, wallMaterial);
                } else {
