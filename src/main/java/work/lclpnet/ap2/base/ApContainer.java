...
public record ApContainer(MinecraftServer server, Logger logger, TranslationService translationService,
                          HookStack hookStack, CommandStack commandStack, SchedulerStack schedulerStack,
                          WorldFacade worldFacade, MapFacade mapFacade, PlayerUtil playerUtil,
                          MiniGameManager miniGames, SongManager songManager) {
